...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_scores_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 36, 0)
    ...
    "scores\0on_commandLinkButton_clicked\0"
    "\0"
};
...
const QMetaObject scores::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_scores.data,
      qt_meta_data_scores,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_scores.stringdata))
